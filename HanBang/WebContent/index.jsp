   ...
   <div class="searchShareHouse">
      ...
      <form action="searchShareHouse.do" method="post">
         <div class="shareHouseGender">
            <label><input type="radio" name="shareHouseGender">성별 무관</label>
            <label><input type="radio" name="shareHouseGender">여성 전용</label>
            <label><input type="radio" name="shareHouseGender">남성 전용</label>
         </div>
         <div class="searchBar">
         ...
         <li>
            <a href="#a">
               <div>
                  <h4>셰어하우스타이틀</h4>
                  <p></p>
                  <div><img src="" alt="셰어하우스"></div>
               </div>
               <div>
                  <p>셰어하우스 주소</p>
                  <span>셰어하우스 타입</span>
                  <span>셰어하우스룸개수</span>
                  <span>셰어하우스화장실개수</span>
                  <p>보증금 / 월세</p>
               </div>
            </a>
         </li>
