...
<link rel="stylesheet" type="text/css" href="${ctx}/resources/css/sub.css">
<link rel="stylesheet" type="text/css" href="${ctx}/resources/css/subMobile.css" media="screen and (max-width:769px)">
<link rel="stylesheet" type="text/css" href="${ctx}/resources/css/subTablet.css" media="screen and (min-width:770px) and (max-width:1023px)">
<script src="${ctx}/resources/js/jquery-3.2.1.min.js"></script>
<script src="${ctx}/resources/js/jquery-ui.js"></script>
<script src="${ctx}/resources/js/hanbangSub.js"></script>